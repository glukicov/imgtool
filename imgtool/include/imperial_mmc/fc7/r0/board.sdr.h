...
U8  SDR4[] = SENSOR_REC ( 4, 16, SENSOR_TYPE_VOLTAGE, 1, 0, 33, 0xF0,
                          SENSOR_UNIT_VOLTS,  6, '+','3','.','3',' ','V' );
U8  SDR5[] = SENSOR_REC ( 5, 32, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0,
                          SENSOR_UNIT_AMPS,  6, '+','3','.','3',' ','I' );
U8  SDR6[] = SENSOR_REC ( 6, 11, SENSOR_TYPE_VOLTAGE, 1, 0, 50, 0xF0,
                          SENSOR_UNIT_VOLTS,  6, '+','5','.','0',' ','V' );
U8  SDR7[] = SENSOR_REC ( 7, 27, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0,
                          SENSOR_UNIT_AMPS,  6, '+','5','.','0',' ','I' );
U8  SDR8[] = SENSOR_REC ( 8, 25, SENSOR_TYPE_VOLTAGE, 1, 0, 25, 0xF0,
                          SENSOR_UNIT_VOLTS,  8, 'L','1','2',' ','V','A','D','J' );
U8  SDR9[] = SENSOR_REC ( 9, 41, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0,
                          SENSOR_UNIT_AMPS,  8, 'L','1','2',' ','I','A','D','J' );
...
U8 SDR12[] = SENSOR_REC ( 12, 21, SENSOR_TYPE_VOLTAGE, 1, 0, 18, 0xF0,
...
U8 SDR18[] = SENSOR_REC ( 18, 20, SENSOR_TYPE_VOLTAGE, 1, 0, 15, 0xF0,
                          SENSOR_UNIT_VOLTS, 6, '+','1','.','5',' ','V' );
U8 SDR19[] = SENSOR_REC ( 19, 36, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0,
                          SENSOR_UNIT_AMPS, 6, '+','1','.','5',' ','I' );
U8 SDR20[] = SENSOR_REC ( 20, 12, SENSOR_TYPE_VOLTAGE, 1, 0, 10, 0xF0,
...
U8 SDR22[] = SENSOR_REC ( 22, 18, SENSOR_TYPE_VOLTAGE, 1, 0, 18, 0xF0,
                          SENSOR_UNIT_VOLTS, 10, '+','1','.','8',' ','V',' ','G','T','X' );
U8 SDR23[] = SENSOR_REC ( 23, 34, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0,
                          SENSOR_UNIT_AMPS, 10, '+','1','.','8',' ','I',' ','G','T','X' );
U8 SDR24[] = SENSOR_REC ( 18, 23, SENSOR_TYPE_VOLTAGE, 1, 0, 10, 0xF0,
                          SENSOR_UNIT_VOLTS, 10, '+','1','.','0',' ','V',' ','G','T','X' );
U8 SDR25[] = SENSOR_REC ( 19, 39, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0,
                          SENSOR_UNIT_AMPS, 10, '+','1','.','0',' ','I',' ','G','T','X' );
U8 SDR26[] = SENSOR_REC ( 20, 15, SENSOR_TYPE_VOLTAGE, 1, 0, 12, 0xF0,
                          SENSOR_UNIT_VOLTS, 10, '+','1','.','2',' ','V',' ','G','T','X' );
U8 SDR27[] = SENSOR_REC ( 21, 31, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0,
                          SENSOR_UNIT_AMPS, 10, '+','1','.','2',' ','I',' ','G','T','X' );
U8 SDR28[] = SENSOR_REC ( 22, 17, SENSOR_TYPE_VOLTAGE, 1, 0, 25, 0xF0,
                          SENSOR_UNIT_VOLTS, 7, 'L','8',' ','V','A','D','J' );
U8 SDR29[] = SENSOR_REC ( 23, 33, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0,
                          SENSOR_UNIT_AMPS, 7, 'L','8',' ','I','A','D','J' );
U8 SDR30[] = SENSOR_REC ( 30, 43, SENSOR_TYPE_VOLTAGE, 1, 0, 0, 0x00,
                          SENSOR_UNIT_VOLTS,  11, 'T','e','s','t',' ','S','e','n','s','o','r' );
...
U8 SDRSizes[] = {  sizeof ( SDR0 ),  sizeof ( SDR1 ),  sizeof ( SDR2 ),  sizeof ( SDR3 ),
                   ...
                   sizeof ( SDR28 ), sizeof ( SDR29 ), sizeof ( SDR30 ),
                };
