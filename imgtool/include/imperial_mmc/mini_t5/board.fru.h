...
static U8 gFRU_Info[] =
{
  ...
  0x00,                   // Padding (00)
  0xEE,                   // Common Header Checksum (0x100 - sum of the above)
  ...
  0xC3,                   // Board Manufacturer String Type / Length
  'I','M','P',    // Board Manufacturer
  /* 18 */
  0xC7,                   // Board Product Name String Type / Length
  'M','I','N','I','-','T','5', // Product Name
  0xC4,                   // Board Serial Number String Type / Length
  '0','0','0','0', // Board Serial
  0xC4,                   // Board Part Number String Type / Length
  'M','I','N','I', // Board Part Number
  /* 36 */
  ...
  0xC3,                   // Product Manufacturer String Type / Length
  'I','M','P',    // Product Manufacturer
  0xC7,                   // Product Product Name String Type / Length
  /* 48 */
  'M','I','N','I','-','T','5', // Product Name
  0xC4,                    // Product Part Num
  'v','1','r','0' + MINI_T5_REV, // Product Version
  /* 60 */
  0xC9,                    // Product Version
  'M','M','C',' ','v','1','.','6','0', // Product Part Num
  ...
  0x19,                   // PSU Current Required (100mA units) (2.5A)
  /* 99 */
  0x00, 0x00
